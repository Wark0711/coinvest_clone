...
function About() {
    return (
        <div className='main-about mt-5'>
            <div className="main-about-head d-flex align-items-center justify-content-start text-light fw-bold fs-5 py-2 px-2">
                <div className="about-head-logo d-flex align-items-center ps-2">
                ...
                <div className="about-head-text text-light mx-3">About</div>
            </div>
            <div className="main-info-cont">
                <p className='m-0 pt-3 px-4 fw-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus sit illo mollitia impedit! Vero commodi labore, in ipsam quidem, odit libero nemo doloremque non tempore doloribus iure ut veritatis mollitia. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
                <p className='m-0 pb-3 fw-semibold px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus sit illo mollitia impedit! Vero commodi labore, in ipsam quidem, odit libero nemo doloremque non tempore doloribus iure ut veritatis mollitia. Lorem ipsum dolor sit amet consectetur adipisicing</p>
            </div>
        </div>
    )
}
